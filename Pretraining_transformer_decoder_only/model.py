...
# -----------------------------------------------------------------------------
# Implementamos un Transformer únicamente con el “decoder stack”, en estilo GPT:
...
class MusicTransformerGPT(nn.Module):
    ...
    def __init__(self, cfg: MTModelConfig):
        ...
        # En caso de querer “weight tying”, compartimos los pesos del embedding
        # con los de la proyección de salida, una práctica común (p.ej. en GPT)
        # para reducir parámetros y a menudo mejorar generalización.
        if cfg.tie_weights:
    ...
    # Este procedimiento es el patrón estándar de muestreo en modelos GPT.
    # =============================================================================
    @torch.no_grad()
