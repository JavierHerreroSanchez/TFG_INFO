...
from src.pretraining.pretraining import (
    INDEX_CSV,
    TOKENS_DIR,
    ANCHOR,
    TOKEN_FIELD,
...
OUTPUT_DIR = (PROJECT_ROOT / "output" / "generation_pretraining_tfg_first" / "batch_2").resolve()
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Evaluación y generación para el pretraining del Music Transformer autorregresivo."
    )
