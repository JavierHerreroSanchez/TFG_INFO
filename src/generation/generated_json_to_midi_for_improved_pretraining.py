...
GENERATED_JSON_PATH = Path(r"../../output/generation_pretraining_tfg_second/sample_009.json")
...
# MIDI de salida
OUTPUT_MIDI_PATH = Path(r"../../output/generation_pretraining_tfg_second/generated_from_json9.mid")
