...
GENERATED_JSON_PATH = Path(r"C:\Users\herre\PycharmProjects\TFG_INFO\output\generation_finetuning_v2\batch_2\best_train\sample_000.json")
...
# MIDI de salida
OUTPUT_MIDI_PATH = Path(r"../../output/generation_finetuning_v2/batch_2/best_train\generated_from_json0.mid")
