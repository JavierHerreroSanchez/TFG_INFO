...
"""
Generación completa desde el modelo de fine-tuning: JSON y MIDI.

Integra la generación autorregresiva de muestras y su conversión inmediata a
MIDI. Mantiene la misma selección de split, prompts, temperatura y top-k que
`generation_from_finetuning_v2.py`.
"""
...
from src.generation.generate_pretraining_json_and_midi import (
    convert_tokens_to_midi,
    save_json_sample,
)
from src.generation.generated_json_to_midi_for_finetuning_v2 import load_tokenizer

from src.generation.generation_from_finetuning_v2 import (
    ADD_EOS,
    CKPT_DIR,
...
def run_generation_and_midi(
    ...
    """Genera muestras de fine-tuning, guarda JSONs y exporta MIDIs."""
