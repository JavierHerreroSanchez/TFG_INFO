...
Optimización:
- Genera PNGs de espectrograma SOLO para los MIDIs generados.
- Para referencias, solo sintetiza y extrae descriptores espectrales, sin guardar PNGs.
- Mantiene comparación por pieza y OA/KLD globales.
"""
...
OUT_DIR = Path(r"/output/generation_v2/midi_spectral_eval")
