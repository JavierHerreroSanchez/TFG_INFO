...
TOKENIZER_PATH = Path(r"../../tokenizer/tokenizer_REMI_BPE.json")

# JSON generado por evaluation.py
GENERATED_JSON_PATH = Path(r"../../output/evaluation/best_train/sample_002.json")
...
# MIDI de salida
OUTPUT_MIDI_PATH = Path(r"../../output\generation\generated_from_json2.mid")
