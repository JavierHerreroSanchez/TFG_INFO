...
"""
Evaluación espectral para MIDIs generados por FINETUNING, basada en audio sintetizado SIN SoundFont.
...
- Baja resolución para acelerar:
  * SAMPLE_RATE = 16000
  * N_FFT = 2048
  * HOP_LENGTH = 512
  * N_MELS = 96
- Elimina métricas que aportan menos para este caso:
  * quita mel_energy
  * quita zcr
- Unifica CSVs cuando es posible:
  * spectral_features_all.csv  -> generado + referencia en un único CSV
  * spectral_evaluation.csv    -> por pieza + bloque global compacto
"""
...
OUT_DIR = Path(r"/output/generation_finetuning_tfg_third/batch_1/best_train/midi_spectral_eval")
...
LOCAL_REF_POOL_SIZE = 32
LOCAL_REF_DURATION_TOL = 0.30  # +/-30%

# Audio / espectrograma (más rápido, pero consistente para generated y reference)
SAMPLE_RATE = 16000
N_FFT = 2048
HOP_LENGTH = 512
N_MELS = 96
...
def choose_reference_files() -> List[Path]:
    ...
    Se usa exclusivamente el subconjunto de GiantPianoMIDI / sonatas aumentadas
    indicado en REFERENCE_DIR.
    """
