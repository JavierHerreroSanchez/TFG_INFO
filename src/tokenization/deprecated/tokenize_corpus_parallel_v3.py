...
# Ponlo a False cuando quieras volver al comportamiento anterior.
IGNORE_BAD_LIST = True

# Muestra por consola los primeros errores reales.
PRINT_FIRST_BAD = 20
...
def build_attribute_controls_indexes(score: Score) -> dict | None:
    """
    Genera índices de AC usando la utilidad oficial de MidiTok.

    Con ratios=1.0:
      - selecciona todos los tracks válidos
      - y todos los compases para los AC de barra

    Esto evita tener que reconstruir manualmente índices de compases
    o depender de métodos privados del tokenizer.
    """
    global TOKENIZER
...
def process_one(midi_str: str) -> tuple[str, str, str]:
    ...
    try:
        ...
        # Importante: preprocess_score inplace antes de pedir AC.
        # La documentación de MidiTok recomienda usar los índices de AC
        # con un score ya preprocesado y luego tokenizar con
        # no_preprocess_score=True para mantener correctos los índices
        # de tracks y barras.
