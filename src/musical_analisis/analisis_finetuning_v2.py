...
SECTIONS = [
    {"label": "Exposición", "start": 0.0, "end": 31.0, "color": "#9ecae1"},
    {"label": "Desarrollo", "start": 31.0, "end": 56.0, "color": "#fdd0a2"},
    {"label": "Coda", "start": 56.0, "end": 72.7, "color": "#c7e9c0"},
]
...
ANNOTATIONS = [
    # Motivo y contestación que indicaste entre 35 y 37 s.
    ...
    # Ajusta estos rangos si quieres estrechar o desplazar el marcado.
...
def plot():
    ...
    # Etiquetas dentro del piano roll, sin leyenda externa.
